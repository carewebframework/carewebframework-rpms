...
public class MainController extends CoverSheetBase<String> {
    ...
    @Override
    protected void init() {
        setup("Patient Education", "Education Detail", "BGOVPED GET", null, -2, "Topic", "Date", "Understanding", "Provider",
            "Group/Individual", "Category", "Code");
        super.init();
    }

    @Override
    protected void requestData() {
        String evt = "PCC." + patient.getIdElement().getIdPart() + ".PED";
