...
public class BEHPatientList extends AbstractPatientList {
    ...
    public BEHPatientList(BrokerSession broker, int listId) {
        this(PatientListUtil.split(broker.callRPC("BEHOPTPL LISTINFO1", listId), 5));
    }
    ...
    public Collection<PatientListItem> getListItems() {
        ...
        List<String> tempList = RPMSUtil.getBrokerSession().callRPCList("BEHOPTPL LISTPTS", null, listId,
