KIDS Distribution saved on Aug 16, 2014@17:55:41
...
CAREWEB DISTRIBUTION (RPMS) 1.0
"BLD",8495,0)
CAREWEB DISTRIBUTION (RPMS) 1.0^^1^3140816^n
"BLD",8495,6.3)
50
"BLD",8495,10,0)
^9.63^35^5
...
"RTN","RGCWFUTL",2,0)
 ;;1.0;CAREWEB FRAMEWORK;;;Build 50
"RTN","RGCWFUTL",3,0)
...
CIA RPC BROKER 1.2
"BLD",8484,0)
CIA RPC BROKER 1.2^^0^3140816^n
"BLD",8484,1,0)
^9.61A^1^1^3101115^^^^
"BLD",8484,1,1,0)
...
"RTN","CIANBACT",2,0)
 ;;1.2;CIA NETWORK COMPONENTS;;Sep 18, 2007;Build 103
"RTN","CIANBACT",3,0)
...
"RTN","CIANBLOG",2,0)
 ;;1.2;CIA NETWORK COMPONENTS;;Jan 3, 2008;Build 103
"RTN","CIANBLOG",3,0)
 ;;Copyright 2000-2008, Medsphere Systems Corporation
"RTN","CIANBLOG",4,0)
 ;=================================================================
...
"RTN","CIANWCG",2,0)
 ;;2.1;WEBMAN;;10-Dec-97 10:12;Build 16
"RTN","CIANWCG",3,0)
...
"RTN","CIANWCG4",2,0)
 ;;2.1;WEBMAN;;23-Aug-96 08:35;Build 16
"RTN","CIANWCG4",3,0)
 ;;Copyright 2000-2003, Clinical Informatics Associates, Inc.
"RTN","CIANWCG4",4,0)
 ;=================================================================
...
"RTN","CIANWINI",2,0)
 ;;2.1;WEBMAN;;06-Mar-1998 12:58 [DKM];Build 16
"RTN","CIANWINI",3,0)
 ;;Copyright 2000-2003, Clinical Informatics Associates, Inc.
"RTN","CIANWINI",4,0)
 ;=================================================================
...
"RTN","CIANWSV1",2,0)
 ;;2.1;WEBMAN;;05-Mar-1998 17:50 [DKM];Build 16
"RTN","CIANWSV1",3,0)
...
"BLD",8485,0)
CAREWEB FRAMEWORK 1.0^CAREWEB FRAMEWORK^0^3140816^n
"BLD",8485,4,0)
^9.64PA^19941.1^3
"BLD",8485,4,999.1,0)
999.1
...
"RTN","RGCWFPAR",2,0)
 ;;1.0;CAREWEB FRAMEWORK;;;Build 81
"RTN","RGCWFPAR",3,0)
...
0^6^B28511794
"RTN","RGCWSEFR",1,0)
RGCWSEFR ;RI/CBMI/DKM - XML FHIR Support ;16-Aug-2014 17:53;DKM
"RTN","RGCWSEFR",2,0)
 ;;1.0;RGCW;;14-March-2014;Build 81
"RTN","RGCWSEFR",3,0)
 ;=================================================================
"RTN","RGCWSEFR",4,0)
...
"RTN","RGCWSEFR",37,0)
 S ATR(1,"rel")="fhir-base",ATR(2,"href")=$G(DATA("HOST"),"broker://RGCWSER+REST/FHIR")
"RTN","RGCWSEFR",38,0)
 D ADDTAG("link",.ATR,1)
"RTN","RGCWSEFR",39,0)
...
0^8^B101913610
"RTN","RGCWSER",1,0)
RGCWSER ;RI/CBMI/DKM - Core Serialization Support ;16-Aug-2014 17:07;DKM
"RTN","RGCWSER",2,0)
 ;;1.0;RGCW;;14-March-2014;Build 81
"RTN","RGCWSER",3,0)
 ;=================================================================
...
"RTN","RGCWSER",37,0)
 N FORMAT,RTN,TOP,IEN,IENS,FILE,SER,INTF,TP,CSTM,N0
"RTN","RGCWSER",38,0)
...
"RTN","RGCWSER",52,0)
 E  I $E(SLCT)=U S TP=1
"RTN","RGCWSER",53,0)
 E  I $E(SLCT,1,2)="$$" S SLCT=SLCT_"(LP,.SLCT)",TP=3
"RTN","RGCWSER",54,0)
 E  I $D(SLCT)>9 S TP=0
"RTN","RGCWSER",55,0)
 ;E  I '$L(SLCT),$D(PARAMS)<10 D SETERR(403,"Invalid request") Q
"RTN","RGCWSER",56,0)
 D:TOP PREINIT^@INTF
"RTN","RGCWSER",57,0)
 I $L(CSTM) X CSTM Q
...
"RTN","RGCWSER",60,0)
 .N LP,CNT,MAX
"RTN","RGCWSER",61,0)
 .S CNT=0,MAX=$S(TP:10000,1:100)
"RTN","RGCWSER",62,0)
 .F LP=0:0 S LP=$S('TP:$O(SLCT(LP)),TP=3:@SLCT,1:$O(@SLCT@(LP))) Q:'LP  D  Q:$$ISERR
"RTN","RGCWSER",63,0)
 ..S IEN=$S(TP:LP,1:SLCT(LP)),CNT=CNT+1
"RTN","RGCWSER",64,0)
 ..I CNT>MAX D SETERR(500,"Too many matches: >"_MAX) Q
"RTN","RGCWSER",65,0)
...
"RTN","RGCWSER",67,0)
 E  D  ; By IEN
"RTN","RGCWSER",68,0)
 .N PROP,PRM,LP,FLD,VALS
"RTN","RGCWSER",69,0)
 .I FLAGS'["S",$P(N0,U,3),'$L(PNAME) D SETERR(403,"Invalid resource type: "_PATH) Q
"RTN","RGCWSER",70,0)
 .M PROP=^RGCWF(999.1,SER,10)
"RTN","RGCWSER",71,0)
 .M:$D(PARAMS)>1 PRM=^RGCWF(999.1,SER,20)
"RTN","RGCWSER",72,0)
 .S IEN=SLCT,LP=""
"RTN","RGCWSER",73,0)
 .F  S LP=$O(PARAMS(LP)) Q:'$L(LP)  I '$D(PRM("B",LP)) D SETERR(403,"Unsupported search parameter: "_LP) Q
"RTN","RGCWSER",74,0)
 .Q:$$ISERR
"RTN","RGCWSER",75,0)
 .I FILE D  Q:'$$FILTER
"RTN","RGCWSER",76,0)
 ..S IENS=IEN_",",FLD=""
"RTN","RGCWSER",77,0)
 ..D BLDFLDS(.PROP,.FLD),BLDFLDS(.PRM,.FLD,.PARAMS)
"RTN","RGCWSER",78,0)
 ..D:$L(FLD) GETS^DIQ(FILE,IENS,FLD,"IE","VALS")
"RTN","RGCWSER",79,0)
...
"RTN","RGCWSER",87,0)
 S URL=CIAMETH_" "_$P($$ENV^CIANWCG("URL"),"/",4,9999)
"RTN","RGCWSER",88,0)
 S HOST="http://"_$$ENV^CIANWCG("Host")
"RTN","RGCWSER",89,0)
 K @DATA
"RTN","RGCWSER",90,0)
...
"RTN","RGCWSER",223,0)
 F X=1:1:$L(VALUE,"&") D
"RTN","RGCWSER",224,0)
 .S Y=$P(VALUE,"&",X),N=$$UNESCAPE($P(Y,"=")),V=$P(Y,"=",2,9999)
"RTN","RGCWSER",225,0)
 .I $L(N) D
"RTN","RGCWSER",226,0)
 ..S Y=1+$O(PARAMS(N,""),-1)
...
LOCALSYS(PATH) ;
"RTN","RGCWSER",258,0)
 Q "http://"_$$LOW^XLFSTR($$KSP^XUPARAM("WHERE"))_"/"_$G(PATH)
"RTN","RGCWSER",259,0)
...
FILTERS D DOCOMP("E")
"RTN","RGCWSER",315,0)
 I 'MATCH,'$L(PVAL("OPR")) S MATCH=$E(VL("E"),1,$L(PVAL))=PVAL
"RTN","RGCWSER",316,0)
 Q
"RTN","RGCWSER",317,0)
 ; Token
"RTN","RGCWSER",318,0)
INITT S:PVAL["|" PVAL(0)=$P(PVAL,"|"),PVAL=$P(PVAL,"|",2)
"RTN","RGCWSER",319,0)
 Q
"RTN","RGCWSER",320,0)
FILTERT D DOCOMP("I")
...
"RTN","RGCWSER",338,0)
 .N X,OPR
"RTN","RGCWSER",339,0)
 .S OPR=PVAL("OPR"),X=VL(IE),MATCH=OPR["="!'$L(OPR)&(X=PVAL)
"RTN","RGCWSER",340,0)
 .I 'MATCH,OPR["<" S MATCH=X<PVAL
"RTN","RGCWSER",341,0)
 .I 'MATCH,OPR[">" S MATCH=X>PVAL
"RTN","RGCWSER",342,0)
 Q
...
"RTN","RGCWSER",345,0)
 N CMP
"RTN","RGCWSER",346,0)
 S VAL=$$UP^XLFSTR(VAL),CMP=$$UP^XLFSTR(PVAL)
"RTN","RGCWSER",347,0)
 S MATCH=$E(VAL,1,$L(CMP))=CMP
"RTN","RGCWSER",348,0)
 Q
"RTN","RGCWSER",349,0)
 ; Name comparison
...
"RTN","RGCWSER",356,0)
 Q
"RTN","RGCWSER",357,0)
 ; Extract operator from search parameter
"RTN","RGCWSER",358,0)
EXTOPR N X,C,I
"RTN","RGCWSER",359,0)
 S X=""
"RTN","RGCWSER",360,0)
 F I=1:1:$L(PVAL) S C=$E(PVAL,I) Q:"<>="'[C  S X=X_C
"RTN","RGCWSER",361,0)
 S:$L(X) PVAL("OPR")=X,PVAL=$E(PVAL,I,9999)
"RTN","RGCWSER",362,0)
 Q
"RTN","RGCWSER",363,0)
...
3140801
"^DD",999.1,999.12,2,0)
TYPE^S^N:NUMBER;D:DATE;S:STRING;T:TOKEN;R:REFERENCE;C:COMPOSITE;Q:QUANTITY;^0;3^Q
"^DD",999.1,999.12,2,3)
...
CAREWEB CONTEXT 1.0
"BLD",8487,0)
CAREWEB CONTEXT 1.0^^0^3140816^n
"BLD",8487,4,0)
^9.64PA^19941.21^4
"BLD",8487,4,999.1,0)
999.1
...
D PUT(PN,"broker://RGCWSER+REST/FHIR/Binary/"_$$SYSUUID^RGCWSER_"/Document/"_VL("I"))
...
"RTN","RGCWENC1",2,0)
 ;;1.0;CAREWEB FRAMEWORK;**005004;20-Aug-2007 08:41;Build 80
"RTN","RGCWENC1",3,0)
 ; Visit creation API
"RTN","RGCWENC1",4,0)
GETVISIT(IN,OUT) ;
...
"RTN","RGCWFTIU",2,0)
 ;;1.0;RGCW;;14-March-2014;Build 80
"RTN","RGCWFTIU",3,0)
 ;=================================================================
"RTN","RGCWFTIU",4,0)
...
"BLD",8497,0)
CAREWEB RPMS ENHANCEMENTS 1.0^^0^3140816^n
"BLD",8497,4,0)
^9.64PA^19941.21^3
"BLD",8497,4,999.1,0)
999.1
