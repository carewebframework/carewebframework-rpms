KIDS Distribution saved on Jul 23, 2014@18:16:24
...
CAREWEB DISTRIBUTION (RPMS) 1.0
"BLD",8495,0)
CAREWEB DISTRIBUTION (RPMS) 1.0^^1^3140723^n
"BLD",8495,6.3)
45
"BLD",8495,10,0)
^9.63^100^4
...
"RTN","RGCWFUTL",2,0)
 ;;1.0;CAREWEB FRAMEWORK;;;Build 45
"RTN","RGCWFUTL",3,0)
...
CIA RPC BROKER 1.1
"BLD",8484,0)
CIA RPC BROKER 1.1^CIA NETWORK COMPONENTS^0^3140723^n
"BLD",8484,1,0)
^9.61A^1^1^3101115^^^^
"BLD",8484,1,1,0)
...
"RTN","CIANBACT",2,0)
 ;;1.1;CIA NETWORK COMPONENTS;**001007**;Sep 18, 2007;Build 77
"RTN","CIANBACT",3,0)
...
"RTN","CIANBASY",2,0)
 ;;1.1;CIA NETWORK COMPONENTS;**001007,001009**;Sep 18, 2007;Build 77
"RTN","CIANBASY",3,0)
...
"RTN","CIANBLIS",2,0)
 ;;1.1;CIA NETWORK COMPONENTS;**001007,001008**;Sep 18, 2007;Build 77
"RTN","CIANBLIS",3,0)
...
"RTN","CIANBLOG",2,0)
 ;;1.1;CIA NETWORK COMPONENTS;**001007,001008**;Jan 3, 2008;Build 77
"RTN","CIANBLOG",3,0)
 ;;Copyright 2000-2008, Medsphere Systems Corporation
"RTN","CIANBLOG",4,0)
 ;=================================================================
...
"BLD",8485,0)
CAREWEB FRAMEWORK 1.0^CAREWEB FRAMEWORK^0^3140723^n
"BLD",8485,4,0)
^9.64PA^19941.21^2
"BLD",8485,4,999.1,0)
999.1
...
RGCWFHIR GETBYKEY^^0
"BLD",8485,"KRN",8994,"NM",29,0)
RGCWFHIR GETBYLST^^0
"BLD",8485,"KRN",8994,"NM","B","RGCWFHIR GETBYIEN",27)

"BLD",8485,"KRN",8994,"NM","B","RGCWFHIR GETBYKEY",28)

"BLD",8485,"KRN",8994,"NM","B","RGCWFHIR GETBYLST",29)
...
0^13
"KRN",8994,2625,0)
RGCWFSER GETBYIEN^GETBYIEN^RGCWFSER^4^^^^0
"KRN",8994,2626,-1)
0^14
"KRN",8994,2626,0)
RGCWFSER GETBYKEY^GETBYKEY^RGCWFSER^4^^^^0
"KRN",8994,2627,-1)
0^15
"KRN",8994,2627,0)
RGCWFSER GETBYLST^GETBYLST^RGCWFSER^4^^^^0
"KRN",8994,2628,-1)
0^17
"KRN",8994,2628,0)
...
0^27
"KRN",8994,2699,0)
RGCWFHIR GETBYIEN^GETBYIEN^RGCWFHIR^4^^^^0
"KRN",8994,2700,-1)
0^28
"KRN",8994,2700,0)
RGCWFHIR GETBYKEY^GETBYKEY^RGCWFHIR^4^^^^0
"KRN",8994,2701,-1)
0^29
"KRN",8994,2701,0)
RGCWFHIR GETBYLST^GETBYLST^RGCWFHIR^4^^^^0
"MBREQ")
1
"ORD",3,19.1)
...
0^6^B39215645
"RTN","RGCWFHIR",1,0)
RGCWFHIR ;RI/CBMI/DKM - JSON FHIR Support ;18-Jul-2014 23:15;PIW
"RTN","RGCWFHIR",2,0)
 ;;1.0;RGCW;;14-March-2014;Build 54
"RTN","RGCWFHIR",3,0)
 ;=================================================================
"RTN","RGCWFHIR",4,0)
...
"RTN","RGCWFHIR",6,0)
GETBYIEN(DATA,RTYPE,IEN,PROP) ;
"RTN","RGCWFHIR",7,0)
 N TOP
"RTN","RGCWFHIR",8,0)
 S TOP=$D(DATA)<10
"RTN","RGCWFHIR",9,0)
 S:'$L($G(DATA)) DATA=$$TMPGBL^CIANBRPC
"RTN","RGCWFHIR",10,0)
 I $D(IEN)>9 D
"RTN","RGCWFHIR",11,0)
 .D:'$D(@DATA) NEWFEED
...
"RTN","RGCWFHIR",15,0)
 ..D NEWENTRY(RTYPE,IEN(LP))
"RTN","RGCWFHIR",16,0)
 ..D GETBYIEN(.DATA,RTYPE,IEN(LP),.PROP)
"RTN","RGCWFHIR",17,0)
 ..D ENDENTRY
"RTN","RGCWFHIR",18,0)
 .D ENDFEED
...
"RTN","RGCWFHIR",20,0)
 .N ATR,SER,RTN
"RTN","RGCWFHIR",21,0)
 .S:'$D(PROP) ATR(0,"xmlns")="http://hl7.org/fhir"
"RTN","RGCWFHIR",22,0)
 .S ATR(1,"id")=RTYPE_"/"_IEN
"RTN","RGCWFHIR",23,0)
 .D ADDTAG($S($D(PROP):PROP,1:RTYPE),.ATR)
"RTN","RGCWFHIR",24,0)
 .S SER=+$O(^RGCWF(999.1,"B","FHIR:"_RTYPE,0))
"RTN","RGCWFHIR",25,0)
...
"RTN","RGCWFHIR",32,0)
GETBYKEY(DATA,RTYPE,KEY,TABLE) ;
"RTN","RGCWFHIR",33,0)
 D GETBYIEN(.DATA,RTYPE,$$FIND1^DIC($$TABLE(TABLE),,"X",KEY))
"RTN","RGCWFHIR",34,0)
 Q
"RTN","RGCWFHIR",35,0)
 ; RPC: Returns a list of entries from a table
"RTN","RGCWFHIR",36,0)
GETBYLST(DATA,RTYPE,LST,TABLE) ;
"RTN","RGCWFHIR",37,0)
 N ARY,GBL,IEN
"RTN","RGCWFHIR",38,0)
...
"RTN","RGCWFHIR",40,0)
 F  S IEN=$O(@ARY@(IEN)) Q:'IEN  S:$D(@GBL@(IEN,0)) IEN(IEN)=IEN
"RTN","RGCWFHIR",41,0)
 D GETBYIEN(.DATA,RTYPE,.IEN)
"RTN","RGCWFHIR",42,0)
 Q
"RTN","RGCWFHIR",43,0)
...
"RTN","RGCWFHIR",48,0)
 D:$D(ID)#1=1 ADDTAG("id",ID,1)
"RTN","RGCWFHIR",49,0)
 S:$D(LINK)#1=1 ATR("href")=LINK,ATR("rel")="self"
"RTN","RGCWFHIR",50,0)
...
"RTN","RGCWFHIR",53,0)
 Q
"RTN","RGCWFHIR",54,0)
ENDFEED D:$G(DATA("FEED")) ENDTAG("feed")
"RTN","RGCWFHIR",55,0)
 K DATA("FEED")
"RTN","RGCWFHIR",56,0)
 Q
"RTN","RGCWFHIR",57,0)
INFEED() Q $D(DATA("FEED"))
"RTN","RGCWFHIR",58,0)
NEWENTRY(RTYP,IEN) ;
"RTN","RGCWFHIR",59,0)
 N ATR
...
"RTN","RGCWFHIR",143,0)
 S (SB,PFX)=""
"RTN","RGCWFHIR",144,0)
 F  S SB=$O(@ARY@(SB)) Q:'$L(SB)  D
"RTN","RGCWFHIR",145,0)
 .N CLS,NM,VL,AR
"RTN","RGCWFHIR",146,0)
 .S VL=@ARY@(SB),AR=$NA(@ARY@(SB)),NM=SB=+SB
"RTN","RGCWFHIR",147,0)
 .I VL="[" S CLS="]"
"RTN","RGCWFHIR",148,0)
 .E  I VL="{" S CLS="}"
"RTN","RGCWFHIR",149,0)
 .E  S:VL'=+VL VL=$$QT(VL)
"RTN","RGCWFHIR",150,0)
 .D PUT(SB,VL):'NM,ADD(PFX_VL):NM,FROMARY(AR),ADD(.CLS):$D(CLS)
"RTN","RGCWFHIR",151,0)
 .S PFX=","
"RTN","RGCWFHIR",152,0)
 Q
...
"RTN","RGCWFHIR",155,0)
 S Y=$O(@DATA@(""),-1)+1
"RTN","RGCWFHIR",156,0)
 S:Y=1 @DATA@(Y)="<?xml version=""1.0"" encoding=""UTF-8""?>",Y=2
"RTN","RGCWFHIR",157,0)
 S @DATA@(Y)=X
"RTN","RGCWFHIR",158,0)
 Q
...
"RTN","RGCWFHIR",178,0)
 .D:CLS ADD("</"_TAG_">")
"RTN","RGCWFHIR",179,0)
 S:'CLS (Y,DATA("T"))=$G(DATA("T"))+1,DATA("T",Y)=TAG
"RTN","RGCWFHIR",180,0)
 K ATR
"RTN","RGCWFHIR",181,0)
 Q
...
"RTN","RGCWFHIR",204,0)
 S:'$G(X) X=$$NOW^XLFDT()
"RTN","RGCWFHIR",205,0)
 S Y=X#1,X=17000000+X\1
"RTN","RGCWFHIR",206,0)
 S:Y Y=Y+1*1000000
"RTN","RGCWFHIR",207,0)
 Q $E(X,1,4)_"-"_$E(X,5,6)_"-"_$E(X,7,8)_$S('Y:"",1:"T"_$E(Y,2,3)_":"_$E(Y,4,5))_$S(Y#100:":"_$E(Y,6,99),1:"")
"RTN","RGCWFHIR",208,0)
ESC(X) N Y,Z,C
"RTN","RGCWFHIR",209,0)
...
"RTN","RGCWFHIR",222,0)
 S:$E(SYSTEM)="@" SYSTEM=$$LOCALSYS($E(SYSTEM,2,999))
"RTN","RGCWFHIR",223,0)
...
"RTN","RGCWFPAR",2,0)
 ;;1.0;CAREWEB FRAMEWORK;;;Build 54
"RTN","RGCWFPAR",3,0)
...
0^3^B10364454
"RTN","RGCWFSER",1,0)
RGCWFSER ;RI/CBMI/DKM - JSON Serialization Support ;17-Jul-2014 08:44;PIW
"RTN","RGCWFSER",2,0)
 ;;1.0;RGCW;;14-March-2014;Build 54
"RTN","RGCWFSER",3,0)
 ;=================================================================
...
"RTN","RGCWFSER",19,0)
 D PUT("domainId",IEN)
"RTN","RGCWFSER",20,0)
 S SER=+$O(^RGCWF(999.1,"B","JSON:"_ALIAS,0))
"RTN","RGCWFSER",21,0)
 S RTN=$G(^RGCWF(999.1,SER,1))
"RTN","RGCWFSER",22,0)
 S RTN=$S($L(RTN):RTN_"(.DATA,IEN)",1:"AUTO(.DATA,IEN,SER)")
...
CAREWEB CONTEXT 1.0
"BLD",8487,0)
CAREWEB CONTEXT 1.0^^0^3140723^n
"BLD",8487,4,0)
^9.64PA^19941.21^4
"BLD",8487,4,999.1,0)
999.1
...
deceasedDateTime^.351^D
"DATA",999.1,16,10,6,0)
MRN^^C
"DATA",999.1,16,10,6,10)
D IDENT("@identifiers/patients",$$HRN^RGCWPTCX(IEN),"MRN")
"DATA",999.1,16,10,8,0)
managingOrganization^^C
"DATA",999.1,16,10,8,10)
D GETBYIEN(.DATA,"Organization",DUZ(2),PN)
"DATA",999.1,17,0)
FHIR:Organization^4
"DATA",999.1,17,10,0)
^999.11^2^2
...
D ADDTAG("period"),PUTDT("start",VL("I"))
"DATA",999.1,19,10,5,0)
period_end^.18^C
"DATA",999.1,19,10,5,10)
D PUTDT("end",VL("I")),ENDTAG("period")
...
N PRV F PRV=0:0 S PRV=$O(^AUPNVPRV("AD",IEN,PRV)) Q:'PRV  D GETBYIEN(.DATA,"EncounterProvider",PRV,"participant")
"DATA",999.1,20,0)
FHIR:Location^44
"DATA",999.1,20,10,0)
^999.11^4^4
...
managingOrganization^3^O
"DATA",999.1,20,10,3,10)
Organization
"DATA",999.1,20,10,4,0)
telecom^99^C
"DATA",999.1,20,10,4,10)
D:$L(VL("E")) ADDTAG(PN),PUT("system","phone"),PUT("value",VL("E")),PUT("use","work"),ENDTAG(PN)
"DATA",999.2,1,0)
...
"RTN","RGCWENC1",2,0)
 ;;1.0;CAREWEB FRAMEWORK;**005004;20-Aug-2007 08:41;Build 52
"RTN","RGCWENC1",3,0)
 ; Visit creation API
"RTN","RGCWENC1",4,0)
GETVISIT(IN,OUT) ;
...
"RTN","RGCWENCX",2,0)
 ;;1.0;CAREWEB FRAMEWORK;;;Build 52
"RTN","RGCWENCX",3,0)
...
"BLD",8497,0)
CAREWEB RPMS ENHANCEMENTS 1.0^^0^3140723^n
"BLD",8497,4,0)
^9.64PA^19941.21^3
"BLD",8497,4,999.1,0)
999.1
