KIDS Distribution saved on May 29, 2014@12:23:16
...
CAREWEB DISTRIBUTION (RPMS) 1.0
"BLD",8495,0)
CAREWEB DISTRIBUTION (RPMS) 1.0^^1^3140529^n
"BLD",8495,6.3)
42
"BLD",8495,10,0)
^9.63^100^4
...
"RTN","CIANBACT",2,0)
 ;;1.1;CIA NETWORK COMPONENTS;**001007**;Sep 18, 2007;Build 70
"RTN","CIANBACT",3,0)
...
"RTN","CIANBASY",2,0)
 ;;1.1;CIA NETWORK COMPONENTS;**001007,001009**;Sep 18, 2007;Build 70
"RTN","CIANBASY",3,0)
...
"RTN","CIANBLIS",2,0)
 ;;1.1;CIA NETWORK COMPONENTS;**001007,001008**;Sep 18, 2007;Build 70
"RTN","CIANBLIS",3,0)
...
"RTN","CIANBLOG",2,0)
 ;;1.1;CIA NETWORK COMPONENTS;**001007,001008**;Jan 3, 2008;Build 70
"RTN","CIANBLOG",3,0)
 ;;Copyright 2000-2008, Medsphere Systems Corporation
"RTN","CIANBLOG",4,0)
 ;=================================================================
...
"RTN","RGCWFSER",2,0)
 ;;1.0;RGCW;;14-March-2014;Build 47
"RTN","RGCWFSER",3,0)
 ;=================================================================
"RTN","RGCWFSER",4,0)
...
"RTN","RGCWENC1",2,0)
 ;;1.0;CAREWEB FRAMEWORK;**005004;20-Aug-2007 08:41;Build 45
"RTN","RGCWENC1",3,0)
 ; Visit creation API
"RTN","RGCWENC1",4,0)
GETVISIT(IN,OUT) ;
...
"BLD",8497,0)
CAREWEB RPMS ENHANCEMENTS 1.0^^0^3140529^n
"BLD",8497,4,0)
^9.64PA^19941.21^3
"BLD",8497,4,999.1,0)
999.1
