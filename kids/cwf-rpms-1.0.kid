KIDS Distribution saved on Mar 17, 2015@14:18:27
...
CAREWEB DISTRIBUTION (RPMS) 1.0
"BLD",8495,0)
CAREWEB DISTRIBUTION (RPMS) 1.0^^1^3150317^n
"BLD",8495,6.3)
136
"BLD",8495,10,0)
^9.63^35^6
...
"RTN","RGCWFUTL",2,0)
 ;;1.0;CAREWEB FRAMEWORK;;;Build 136
"RTN","RGCWFUTL",3,0)
...
RG UTILITIES 3.0
"BLD",8503,0)
RG UTILITIES 3.0^RUN TIME LIBRARY^0^3150317^n
"BLD",8503,1,0)
^^3^3^3150202^^^
"BLD",8503,1,1,0)
...
"RTN","RGUT",2,0)
 ;;3.0;RG UTILITIES;**1**;Mar 20, 2007;Build 281
"RTN","RGUT",3,0)
 ;;
"RTN","RGUT",4,0)
 ;=================================================================
...
"RTN","RGUT1",2,0)
 ;;3.0;RG UTILITIES;;Mar 20, 2007;Build 281
"RTN","RGUT1",3,0)
 ;;
"RTN","RGUT1",4,0)
 ;=================================================================
...
"RTN","RGUTDATF",2,0)
 ;;3.0;RG UTILITIES;;Feb 20, 2015;Build 281
"RTN","RGUTDATF",3,0)
...
CIA RPC BROKER 1.3
"BLD",8484,0)
CIA RPC BROKER 1.3^^0^3150317^n
"BLD",8484,1,0)
^9.61A^1^1^3101115^^^^
"BLD",8484,1,1,0)
...
"RTN","CIANBACT",2,0)
 ;;1.3;CIA NETWORK COMPONENTS;;Sep 18, 2007;Build 322
"RTN","CIANBACT",3,0)
...
"RTN","CIANBLOG",2,0)
 ;;1.3;CIA NETWORK COMPONENTS;;Jan 3, 2008;Build 322
"RTN","CIANBLOG",3,0)
 ;;Copyright 2000-2008, Medsphere Systems Corporation
"RTN","CIANBLOG",4,0)
 ;=================================================================
...
"BLD",8505,0)
SERIALIZATION FRAMEWORK 1.0^SERIALIZATION FRAMEWORK^0^3150317^n
"BLD",8505,1,0)
^^2^2^3150301.07231
"BLD",8505,1,1,0)
...
"DATA",998.1,2,0)
DSTU1^application/xml+fhir,application/xml,text/xml^RGSEFHIR^0.0.82-3059
"DATA",998.1,2,10,0)
^998.11^46^46
"DATA",998.1,2,10,1,0)
Binary
...
D:VL(3) ADDTAG(PN),REF2(PN,"Location",VL(3,"I"),VL(3,"E")),PERIOD,ENDTAG(PN)
...
N PRV F PRV=0:0 S PRV=$O(^AUPNVPRV("AD",IEN,PRV)) Q:'PRV  D GET^RGSERGET(.DATA,"*/Encounter_Participant",PRV,PN)
...
I $D(VL("I")),$$ISNUM^RGUT(VL("I")) D ADDTAG(PN),PUT("value",VL("I")) D:$D(VL(2,"I")) PUT("units",VL(2,"I")) D ENDTAG(PN)
...
D IDENT("@identifiers/patients",$$HRN^RGSERPAT(IEN),PN)
"DATA",998.1,2,10,13,30,6,0)
managingOrganization^^C^80
"DATA",998.1,2,10,13,30,6,10)
D GET^RGSERGET(.DATA,"*/Organization_Reference",DUZ(2),PN)
...
D ADDTAG(PN),GET^RGSERGET(.DATA,"*/"_VL("E"),,"concept"),ENDTAG(PN)
...
D CODING(PN,$$SYSTEM^RGSER("#"_FILE),IEN,VL("E"))
...
"DATA",998.1,2,10,45,50,1,1,12,0)
    <description value="VistA (|@DATA("SERNM")|)"/>
"DATA",998.1,2,10,45,50,1,1,13,0)
  </implementation>
"DATA",998.1,2,10,45,50,1,1,14,0)
  <fhirVersion value="|@DATA("VER")|"/>
...
"DATA",998.1,3,0)
DSTU2^application/xml+fhir,application/xml,text/xml^RGSEFHIR^0.4.0
"DATA",998.1,3,10,0)
^998.11^49^49
"DATA",998.1,3,10,1,0)
Binary
...
0^1^B57974853
"RTN","RGSEFHIR",1,0)
RGSEFHIR ;RI/CBMI/DKM - XML FHIR Support ;17-Mar-2015 09:27;DKM
"RTN","RGSEFHIR",2,0)
 ;;1.0;SERIALIZATION FRAMEWORK;;07-Feb-2015 08:51;Build 185
"RTN","RGSEFHIR",3,0)
 ;=================================================================
"RTN","RGSEFHIR",4,0)
...
"RTN","RGSEFHIR",8,0)
 S:$$ISBROWSR^RGSER DATA("CTYPE")="text/xml"
"RTN","RGSEFHIR",9,0)
 Q
"RTN","RGSEFHIR",10,0)
...
"RTN","RGSEFHIR",21,0)
 S TAG=$P($S($L(PNAME):PNAME,1:$P(PATH,"/",$L(PATH,"/"))),"_")
"RTN","RGSEFHIR",22,0)
...
"RTN","RGSEFHIR",27,0)
 S:$E(TAG)="@" TAG=""
"RTN","RGSEFHIR",28,0)
 D ADDTAG(TAG,.ATR):$L(TAG),PROCPROP^RGSERGET,ENDTAG(TAG):$L(TAG)
"RTN","RGSEFHIR",29,0)
 D:ENTRY ENDENTRY
"RTN","RGSEFHIR",30,0)
 Q
...
"RTN","RGSEFHIR",66,0)
 N ATR
"RTN","RGSEFHIR",67,0)
 S:'$$ISBROWSR^RGSER DATA("CTYPE")="application/atom+xml"
"RTN","RGSEFHIR",68,0)
...
"RTN","RGSEFHIR",141,0)
 D ADDTAG("text"),PUT("status","generated"),ADDTAG("div",.ATR)
"RTN","RGSEFHIR",142,0)
 I $D(TXT)=1 D
"RTN","RGSEFHIR",143,0)
 .D ADD^RGSER($$ESCAPE^RGSER(TXT))
"RTN","RGSEFHIR",144,0)
 E  D
"RTN","RGSEFHIR",145,0)
 .S LP=""
"RTN","RGSEFHIR",146,0)
 .F  S LP=$O(TXT(LP)) Q:'$L(LP)  D ADD^RGSER(TXT(LP))
"RTN","RGSEFHIR",147,0)
 D ENDTAG("text")
"RTN","RGSEFHIR",148,0)
 Q
...
"RTN","RGSEFHIR",198,0)
 Q
"RTN","RGSEFHIR",199,0)
TELECOM D:VL ADDTAG(PN),PUT("system",$P(PN(0),":")),PUT("use",$P(PN(0),":",2)),PUT("value",VL("E")),ENDTAG(PN)
"RTN","RGSEFHIR",200,0)
 Q
"RTN","RGSEFHIR",201,0)
 ; Process a period datatype
"RTN","RGSEFHIR",202,0)
PERIOD I $G(VL("I"))!$G(VL(2,"I")) D
"RTN","RGSEFHIR",203,0)
 .D ADDTAG("period")
"RTN","RGSEFHIR",204,0)
 .D:$G(VL("I")) PUTDT("start",VL("I"))
"RTN","RGSEFHIR",205,0)
 .D:$G(VL(2,"I")) PUTDT("end",VL(2,"I"))
"RTN","RGSEFHIR",206,0)
 .D ENDTAG("period")
"RTN","RGSEFHIR",207,0)
 Q
...
"RTN","RGSEFHIR",241,0)
 S RESNAME=""
"RTN","RGSEFHIR",242,0)
 F  S RESNAME=$O(^RGSER(998.1,DATA("SER"),10,"B",RESNAME)) Q:'$L(RESNAME)  S RESIEN=$O(^(RESNAME,0)) D
"RTN","RGSEFHIR",243,0)
 .Q:RESNAME="metadata"!(RESNAME["/")
"RTN","RGSEFHIR",244,0)
 .Q:$P(^RGSER(998.1,DATA("SER"),10,RESIEN,0),U,2)
"RTN","RGSEFHIR",245,0)
...
SRPCONF() ;
"RTN","RGSEFHIR",251,0)
 N SRPNAME,SRPIEN,SRPTYPE
"RTN","RGSEFHIR",252,0)
 S SRPNAME=""
"RTN","RGSEFHIR",253,0)
 F  S SRPNAME=$O(^RGSER(998.1,DATA("SER"),10,RESIEN,40,"B",SRPNAME)) Q:'$L(SRPNAME)  S SRPIEN=$O(^(SRPNAME,0)) D
"RTN","RGSEFHIR",254,0)
 .Q:$E(SRPNAME)="@"
"RTN","RGSEFHIR",255,0)
 .S SRPTYPE=$P(^RGSER(998.1,DATA("SER"),10,RESIEN,40,SRPIEN,0),U,3)
"RTN","RGSEFHIR",256,0)
 .S SRPTYPE=$$LOW^XLFSTR($$EXTERNAL^DILFD(998.13,2,,SRPTYPE))
"RTN","RGSEFHIR",257,0)
 .D:$L(SRPTYPE) TEMPLATE^RGSERGET("CONFORMANCE_PARAMETER")
"RTN","RGSEFHIR",258,0)
 Q:$Q ""
"RTN","RGSEFHIR",259,0)
 Q
...
0^2^B5869093
"RTN","RGSEJSON",1,0)
RGSEJSON ;RI/CBMI/DKM - JSON Serialization Support ;13-Mar-2015 14:27;DKM
"RTN","RGSEJSON",2,0)
 ;;1.0;SERIALIZATION FRAMEWORK;;14-March-2014;Build 185
"RTN","RGSEJSON",3,0)
 ;=================================================================
"RTN","RGSEJSON",4,0)
 ; Implements Serializer interface
...
"RTN","RGSEJSON",59,0)
 ; Serializer.PROPO - Object property
"RTN","RGSEJSON",60,0)
PROPO D:$G(VL("I")) GET^RGSERGET(.DATA,CTL,$G(VL("I")),PN)
"RTN","RGSEJSON",61,0)
 Q
"RTN","RGSEJSON",62,0)
 ; Serializer.PROPI - Inline property
...
PUTDT(NM,DT) ;
"RTN","RGSEJSON",79,0)
 D:DT PUTQT(NM,$$FMTDATE^RGSER(DT))
"RTN","RGSEJSON",80,0)
 Q
"RTN","RGSEJSON",81,0)
...
0^3^B72175606
"RTN","RGSER",1,0)
RGSER ;RI/CBMI/DKM - Core Serialization Support ;16-Mar-2015 15:22;DKM
"RTN","RGSER",2,0)
 ;;1.0;SERIALIZATION FRAMEWORK;;14-March-2014;Build 185
"RTN","RGSER",3,0)
 ;=================================================================
...
"RTN","RGSER",16,0)
 D INIT,GET^RGSERGET(.DATA,.PATH,.SLCT,.PNAME,.PARAMS,.FLAGS),CLEANUP
"RTN","RGSER",17,0)
 Q
"RTN","RGSER",18,0)
...
"RTN","RGSER",35,0)
 I $D(PARAMS("_format",1,1)) D
"RTN","RGSER",36,0)
 .S DATA("HDR","accept")=PARAMS("_format",1,1)
"RTN","RGSER",37,0)
 .K PARAMS("_format")
"RTN","RGSER",38,0)
 S X=$L(HOST)
...
"RTN","RGSER",71,0)
 ; GET method
"RTN","RGSER",72,0)
MGET D GET^RGSERGET(.DATA,PATH,.ID,,.PARAMS)
"RTN","RGSER",73,0)
 Q
"RTN","RGSER",74,0)
 ; POST method
...
"RTN","RGSER",137,0)
 N Y,Z,C,R,L
"RTN","RGSER",138,0)
 S R=$$ESCMAP^@DATA("INTF"),L=$P(R,U),R=$P(R,U,2)
"RTN","RGSER",139,0)
...
"RTN","RGSER",273,0)
 Q $TR(PATH,"-_","XX")?@PTRN
"RTN","RGSER",274,0)
 ; Returns nonzero if content type matches an accepted type
"RTN","RGSER",275,0)
ISTYPE(MTYPE,ACCPT) ;
"RTN","RGSER",276,0)
 N AT,LP,MT,R,X,Q
...
ISBROWSR() ;
"RTN","RGSER",296,0)
 Q $G(DATA("HDR","user-agent"))["Mozilla"
"RTN","RGSERDD")
0^12^B1259321
"RTN","RGSERDD",1,0)
RGSERDD ;RI/CBMI/DKM - Data dictionary logic ;17-Mar-2015 10:20;DKM
"RTN","RGSERDD",2,0)
 ;;1.0;SERIALIZATION FRAMEWORK;;14-March-2014;Build 185
"RTN","RGSERDD",3,0)
 ;=================================================================
...
"RTN","RGSERDD",29,0)
 .N DATA
"RTN","RGSERDD",30,0)
 .S DATA="DATA",DATA("SER")=DA(2),DATA("SERNM")=$P(^RGSER(998.1,DA(2),0),U)
"RTN","RGSERDD",31,0)
...
0^4^B1669043
"RTN","RGSERENC",1,0)
RGSERENC ;RI/CBMI/DKM - Encounter Resource Support ;16-Mar-2015 11:09;DKM
"RTN","RGSERENC",2,0)
 ;;1.0;SERIALIZATION FRAMEWORK;;07-Feb-2015 08:51;Build 185
"RTN","RGSERENC",3,0)
 ;=================================================================
"RTN","RGSERENC",4,0)
 ; Get encounter types
"RTN","RGSERENC",5,0)
GETTYPES I '$D(DATA("RGSERENC.SVCCAT")) D
"RTN","RGSERENC",6,0)
 .N SC,X
"RTN","RGSERENC",7,0)
 .S (SLCT,DATA("RGSERENC.SVCCAT"))=$$TMPGBL^RGSER,TP=1
"RTN","RGSERENC",8,0)
...
RETRIEVE(IEN) ;
"RTN","RGSERENC",13,0)
 D RETRIEVE^RGSERGET(DATA("RGSERENC.SVCCAT"),IEN,"~")
"RTN","RGSERENC",14,0)
 Q
"RTN","RGSERENC",15,0)
...
0^11^B145631659
"RTN","RGSERGET",1,0)
RGSERGET ;RI/CBMI/DKM - GET method support ;16-Mar-2015 18:04;DKM
"RTN","RGSERGET",2,0)
 ;;1.0;SERIALIZATION FRAMEWORK;;14-March-2014;Build 185
"RTN","RGSERGET",3,0)
 ;=================================================================
...
"RTN","RGSERGET",67,0)
 S (ID,IEN)=SLCT
"RTN","RGSERGET",68,0)
 I FILE!$L(XRDR) D  Q:$$ISERR^RGSER  I '$$FILTER D:'$$HASFLAG^RGSER("L") SETERR^RGSER(404,"Not found") Q
"RTN","RGSERGET",69,0)
 .S IENS=IEN_","
"RTN","RGSERGET",70,0)
...
"RTN","RGSERGET",142,0)
 S SER=$$GETSER(PATH)
"RTN","RGSERGET",143,0)
 I SER<0 D SETERR^RGSER($S(SER=-2:"406^Not acceptable",1:"404^Not Found")) Q ""
"RTN","RGSERGET",144,0)
 I '$G(DATA("SER")) D
"RTN","RGSERGET",145,0)
 .S DATA("SER")=SER,N0=^RGSER(998.1,SER,0)
"RTN","RGSERGET",146,0)
 .S DATA("SERNM")=$P(N0,U),DATA("CTYPE")=$P($P(N0,U,2),","),DATA("INTF")=$P(N0,U,3),DATA("VER")=$P(N0,U,4)
"RTN","RGSERGET",147,0)
 S RES=$$GETRES(PATH)
"RTN","RGSERGET",148,0)
 I 'RES D SETERR^RGSER("404","Not Found") Q ""
"RTN","RGSERGET",149,0)
...
"RTN","RGSERGET",157,0)
 S SERNM=$P(PATH,"/"),SER=+$G(DATA("SER"))
"RTN","RGSERGET",158,0)
 Q:'$L(SERNM) -1
"RTN","RGSERGET",159,0)
 Q:SER $S(SERNM="*":SER,SERNM=DATA("SERNM"):SER,1:-3)
"RTN","RGSERGET",160,0)
 S ACCPT=$G(DATA("HDR","accept")),(FND,MWT,SERX)=0
"RTN","RGSERGET",161,0)
 F IEN=0:0 S IEN=$S(SER:SER,1:$O(^RGSER(998.1,"B",SERNM,IEN))) Q:'IEN  D  Q:MWT=1!SER
"RTN","RGSERGET",162,0)
 .S MTYPE=$P(^RGSER(998.1,IEN,0),U,2),WT=$$ISTYPE^RGSER(MTYPE,ACCPT),FND=1
"RTN","RGSERGET",163,0)
...
"RTN","RGSERGET",169,0)
 S (START,LP)=$P(PATH,"/",2),PATH=$P(PATH,"/",2,999),D1=DATA("SER"),RES=0,LEN=$L(START)
"RTN","RGSERGET",170,0)
 Q:'$L(START) 0
"RTN","RGSERGET",171,0)
...
"RTN","RGSERGET",178,0)
 S SER=$$GETSER(SERNM)
"RTN","RGSERGET",179,0)
 I SER'>0 D SETERR^RGSER("404","Not Found") Q
"RTN","RGSERGET",180,0)
 S DATA("CTYPE")="text/html"
"RTN","RGSERGET",181,0)
...
"RTN","RGSERGET",410,0)
 .S:RESN'=+RESN RESN=$O(^RGSER(998.1,DATA("SER"),10,"B",RESN,0))
"RTN","RGSERGET",411,0)
 .S:RESN SERX=$NA(^RGSER(998.1,DATA("SER"),10,RESN))
"RTN","RGSERGET",412,0)
 E  S SERX=SER
"RTN","RGSERGET",413,0)
...
0^6^B13448385
"RTN","RGSERLAB",1,0)
RGSERLAB ;RI/CBMI/DKM - Return lab observations. ;17-Mar-2015 09:04;DKM
"RTN","RGSERLAB",2,0)
 ;;1.0;SERIALIZATION FRAMEWORK;;07-Feb-2015 08:51;Build 185
"RTN","RGSERLAB",3,0)
 ;=================================================================
...
"RTN","RGSERLAB",40,0)
 I $L($G(ID)),ID'=ANID Q
"RTN","RGSERLAB",41,0)
 S ARY=$$ARY^RGSEROBS(DATA),MAX=MAX-1
"RTN","RGSERLAB",42,0)
 D PUT("id",ANID)
"RTN","RGSERLAB",43,0)
...
"RTN","RGSEROBS",14,0)
 S:'$D(DATA("RGSEROBS")) DATA("RGSEROBS")=$$OBS(,ID),IEN=1
"RTN","RGSEROBS",15,0)
 M VALS(0,IENS)=@DATA("RGSEROBS")@(IEN)
"RTN","RGSEROBS",16,0)
 Q
"RTN","RGSEROBS",17,0)
...
"RTN","RGSEROBS",50,0)
 D ADDTAG^RGSEXML(PN)
"RTN","RGSEROBS",51,0)
 D:$L(LOW) ADDTAG^RGSEXML("low"),PUT^RGSEXML("value",LOW),ENDTAG^RGSEXML("low")
"RTN","RGSEROBS",52,0)
 D:$L(HIGH) ADDTAG^RGSEXML("high"),PUT^RGSEXML("value",HIGH),ENDTAG^RGSEXML("high")
"RTN","RGSEROBS",53,0)
 D ENDTAG^RGSEXML(PN)
"RTN","RGSEROBS",54,0)
 Q
...
0^13^B151306
"RTN","RGSERPER",1,0)
RGSERPER ;RI/CBMI/DKM - User/Practitioner/Person Resource Support ;17-Mar-2015 08:54;DKM
"RTN","RGSERPER",2,0)
 ;;1.0;SERIALIZATION FRAMEWORK;;07-Feb-2015 08:51;Build 185
"RTN","RGSERPER",3,0)
 ;=================================================================
...
0^9^B11357488
"RTN","RGSERVIT",1,0)
RGSERVIT ;RI/CBMI/DKM - Return vital observations. ;17-Mar-2015 09:04;DKM
"RTN","RGSERVIT",2,0)
 ;;1.0;SERIALIZATION FRAMEWORK;;07-Feb-2015 08:51;Build 185
"RTN","RGSERVIT",3,0)
 ;=================================================================
...
"RTN","RGSERVIT",32,0)
 S ARY=$$ARY^RGSEROBS(DATA),MAX=MAX-1,HI=+$G(HI),LO=+$G(LO),UNITS=$G(UNITS),LOINC=$G(LOINC)
"RTN","RGSERVIT",33,0)
 D PUT("id",ANID)
"RTN","RGSERVIT",34,0)
 D FILE^RGSEROBS("patient",DFN,2)
...
0^10^B12291502
"RTN","RGSEXML",1,0)
RGSEXML ;RI/CBMI/DKM - XML Support ;15-Mar-2015 11:57;DKM
"RTN","RGSEXML",2,0)
 ;;1.0;SERIALIZATION FRAMEWORK;;14-March-2014;Build 185
"RTN","RGSEXML",3,0)
 ;=================================================================
...
"RTN","RGSEXML",51,0)
 ; Serializer.PROPO - Object property
"RTN","RGSEXML",52,0)
PROPO D:$G(VL("I")) GET^RGSERGET(.DATA,CTL,VL("I"),PN)
"RTN","RGSEXML",53,0)
 Q
"RTN","RGSEXML",54,0)
 ; Serializer.PROPI - Inline object property
"RTN","RGSEXML",55,0)
PROPI D:$G(VL("I")) ADDTAG(PN),GET^RGSERGET(.DATA,CTL,VL("I"),,,"I"),ENDTAG(PN)
"RTN","RGSEXML",56,0)
 Q
"RTN","RGSEXML",57,0)
 ; Serializer.PROPS - Static property
...
"RTN","RGSEXML",93,0)
 .S X=$L(TAG,":")
"RTN","RGSEXML",94,0)
 .F TGC=1:1:X-1 D ADDTAG($P(TAG,":",TGC))
"RTN","RGSEXML",95,0)
 .S TAG=$P(TAG,":",X)
"RTN","RGSEXML",96,0)
 I $D(ATR)'>1 D
...
"BLD",8485,0)
CAREWEB FRAMEWORK 1.0^CAREWEB FRAMEWORK^0^3150317^n
"BLD",8485,4,0)
^9.64PA^998.1^2
"BLD",8485,4,998.1,0)
998.1
...
"RTN","RGCWFPAR",2,0)
 ;;1.0;CAREWEB FRAMEWORK;;;Build 300
"RTN","RGCWFPAR",3,0)
...
"RTN","RGCWKDIN",119,0)
 Q:'CTX
"RTN","RGCWKDIN",120,0)
 F X="RG","CIA","DG","DDR","BEH" D REGNMSP^RGUTRPC(X,CTX)
"RTN","RGCWKDIN",121,0)
...
CAREWEB CONTEXT 1.0
"BLD",8487,0)
CAREWEB CONTEXT 1.0^^0^3150317^n
"BLD",8487,4,0)
^9.64PA^998.1^4
"BLD",8487,4,998.1,0)
998.1
...
"RTN","RGCWENC1",2,0)
 ;;1.0;CAREWEB FRAMEWORK;**005004;20-Aug-2007 08:41;Build 296
"RTN","RGCWENC1",3,0)
 ; Visit creation API
"RTN","RGCWENC1",4,0)
GETVISIT(IN,OUT) ;
...
"RTN","RGCWENCX",2,0)
 ;;1.0;CAREWEB FRAMEWORK;;;Build 296
"RTN","RGCWENCX",3,0)
...
"RTN","RGCWFTIU",2,0)
 ;;1.0;RGCW;;14-March-2014;Build 296
"RTN","RGCWFTIU",3,0)
 ;=================================================================
"RTN","RGCWFTIU",4,0)
...
"BLD",8497,0)
CAREWEB RPMS ENHANCEMENTS 1.0^^0^3150317^n
"BLD",8497,4,0)
^9.64PA^998.1^3
"BLD",8497,4,998.1,0)
998.1
